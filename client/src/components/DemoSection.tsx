      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-12">
            Experience the future of chemistry education with our interactive
            platform. Watch molecules come to life, simulate reactions, and
            explore the molecular world like never before.
          </p>
        </div>
            ...
            <div className="relative aspect-video bg-gradient-dark p-8 flex items-center justify-center">
              ...
              <div className="text-center space-y-6">
                ...
                <div className="flex justify-center gap-4 mb-8">
                  ...
                  <div
                    className="w-12 h-12 bg-secondary rounded-full shadow-glow-secondary animate-float"
                    style={{ animationDelay: "1s" }}
                  ></div>
                  <div
                    className="w-20 h-20 bg-accent rounded-full shadow-glow-accent animate-float"
