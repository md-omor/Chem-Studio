      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader className="pb-4">
          <div className="flex items-center space-x-4">
            <div
              className={`w-16 h-16 rounded-lg flex flex-col items-center justify-center text-white ${getCategoryClass(
                element.category
              )}`}
            >
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  {element.uses || "Various applications"}
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  {element.fact ||
                    "A fascinating element with unique properties."}
                </p>
              </div>
                ...
                {showAiExplanation && (
                  <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                    {isLoadingExplanation ? (
                      ...
                      <div className="text-blue-600 text-sm">
                        Unable to get AI explanation at the moment.
                      </div>
                    )}
                  </div>
                )}
